...
namespace OrderMnagementAPIs.Models
{
    ...
    public class Users
    {
        ...
        public string UserName { get; set; } // User's name, required field

        [Required] // Ensures email is mandatory
        [EmailAddress] // Validates the property follows email format
        public string UserEmail { get; set; } // User's email address, must be unique

        [Required] // Ensures password is mandatory
        public string UserPassword { get; set; } // User's hashed password

        [Required] // Ensures phone number is mandatory
        [Phone] // Validates the property follows a phone number format
        public string UserPhone { get; set; } // User's phone number, e.g., +1234567890
